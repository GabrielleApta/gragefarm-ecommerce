        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
            <div class="wrap-product-detail">
                    ...
                    <div class="product-gallery">
                        <ul class="" style="list-style: none">
                            <li>
                                ...
                                @else
                                    Tidak ada gambar produk yang di tambah
                                @endif
                            </li>
                        </ul>
                    </div>
                ...
                <div class="detail-info">
                    ...
                    <div class="wrap-price"><span class="product-price">Rp. {{ $product->selling_price }}</span></div>
                    <div class="quantity">
                        <span>Jumlah Pesanan</span>
                        <div class="quantity-input">
                            <input type="text" name="product-quatity" wire:model="quantityCount"
                                value="{{ $this->quantityCount }}" readonly>
                            <span class="btn btn-reduce" wire:click="decrementQuantity"></span>
                            <span class="btn btn-increase" wire:click="incrementQuantity"></span>
                        </div>
                    </div>
                    <div class="wrap-butons">
                        <a href="#" wire:click="addToCart({{ $product->id }})" class="btn add-to-cart">Tambah Ke
                            Keranjang</a>
                    </div>
                </div>
                <div class="advance-info">
                    <div class="tab-control normal">
                        <a href="#add_infomation" class="tab-control-item active">Detail Produk</a>
                        ...
                        <div class="tab-content-item active" id="add_infomation">
                            <table class="shop_attributes">
                                <tbody>
                                    <tr>
                                        <th>Stok</th>
                                        <td class="product_weight">{{ $product->quantity }}</td>
                                    </tr>
                                    <tr>
                                        <th>Penjual</th>
                                        <td class="product_dimensions">{{ $product->brand }}</td>
                                    </tr>
                                    <tr>
                                        <th>Deskripsi</th>
                                        <td class="product_dimensions" style="font-weight: 500">{!! $product->description !!}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
