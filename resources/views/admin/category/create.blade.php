  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 style="display: flex; justify-content: space-between; align-items: center;">Tambah Data Kategori
          <a href="{{ url('admin/category') }}" class="btn text-white" style="background-color: #00726c;">Kembali</a>
        </h4>
      </div>
      <div class="card-body">
        <form action="{{ url('admin/category') }}" method="POST"class="mt-4" enctype="multipart/form-data">
