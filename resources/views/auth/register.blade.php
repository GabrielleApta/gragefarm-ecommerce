                    ...
                    <div class="mid-section main-info-area">
                        ...
                        <div class="wrap-icon right-section">
                            ...
                            <div class="wrap-icon-section minicart" style="position: relative; left: 70%;">
                                <a href="#" class="link-direction">
                                    <div class="left-info">
                                        <button type="button" class="btn" style="background-color: #00726c; width: 100px; color: #fff;"><a href="{{route('login')}}" style="color: #fff">Masuk</a></button>
                                    </div>
                                </a>
                            </div>
    ...
    <main id="main">
        <div class="container">
            <div class="wrap-breadcrumb">
                <ul>
                    <li class="item-link"><a href="#" class="link">Daftar</a></li>
                </ul>
            </div>
            <div class="row">
                            ...
                            <div class="login-form form-item form-stl">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <fieldset class="wrap-input">
                                        <label for="frm-login-uname">Nama</label>
                                    ...
                                    <fieldset class="wrap-input">
                                        <label for="frm-login-pass">Konfirmasi Password</label>
                                    ...
                                    <input type="submit" class="btn form-control" value="Daftar" name="submit" style="background-color: #00726c; height: 40px">
